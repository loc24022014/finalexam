<?php
$pageTitle = 'Chỉnh Sửa Phân Khúc - Admin';
...
<div class="admin-page">
    ...
    <div class="form-wrapper glass-card mt-4 max-w-xl mx-auto" style="border: 1px solid var(--border-strong); padding: 2rem;">
        <div class="form-header">
            <h1 class="form-title" style="font-family: var(--font-heading); font-style: italic; text-transform: uppercase;">Chỉnh Sửa <span>Phân Khúc</span></h1>
            <p class="form-subtitle" style="color: var(--text-muted); font-size: 0.9rem;">Cập nhật thông tin chi tiết và đường dẫn của phân khúc xe này</p>
        </div>
        ...
        <form id="edit-category-form" class="premium-form">
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="name" name="name" class="form-input" value="<?= htmlspecialchars($category->name) ?>" placeholder="Ví dụ: Xe Điện, Xe SUV hạng sang..." style="background: rgba(0,0,0,0.5); border: 1px solid var(--border); color: #fff; padding: 0.8rem;" required>
            </div>
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="slug" name="slug" class="form-input" value="<?= htmlspecialchars($category->slug ?? '') ?>" placeholder="Ví dụ: xe-dien-hang-sang (Để trống tự sinh)" style="background: rgba(0,0,0,0.5); border: 1px solid var(--border); color: #fff; padding: 0.8rem;">
            </div>
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <textarea id="description" name="description" class="form-input" rows="4" placeholder="Mô tả ngắn gọn đặc trưng của phân khúc xe này..." style="background: rgba(0,0,0,0.5); border: 1px solid var(--border); color: #fff; padding: 0.8rem;"><?= htmlspecialchars($category->description ?? '') ?></textarea>
            </div>
