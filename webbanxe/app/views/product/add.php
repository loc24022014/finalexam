...
<div class="container py-5">
    ...
    <div class="form-wrapper glass-card mt-4 max-w-3xl mx-auto">
        <div class="form-header">
            <h1 class="form-title">Thêm Xe Mới</h1>
            <p class="form-subtitle">Điền thông tin và tải lên hình ảnh để thêm dòng xe mới vào hệ thống</p>
        </div>
        ...
        <form id="add-product-form" class="premium-form">
            <div class="form-grid">
                <div class="form-group col-span-2">
                    <label for="name" class="form-label">Tên Dòng Xe <span class="required">*</span></label>
                    <input type="text" id="name" name="name" class="form-input" placeholder="Ví dụ: Ford Everest Titanium 2024" required>
                </div>

                <div class="form-group">
                    <label for="brand" class="form-label">Hãng Xe (Brand)</label>
                    <input type="text" id="brand" name="brand" class="form-input" placeholder="Ví dụ: Ford, Toyota, BMW...">
                </div>

                <div class="form-group">
                    <label for="price" class="form-label">Giá Bán (₫) <span class="required">*</span></label>
                    <input type="number" id="price" name="price" class="form-input" placeholder="Ví dụ: 1350000000" min="0" required>
                </div>

                <div class="form-group col-span-2">
                    <label for="category_id" class="form-label">Phân Khúc / Danh Mục <span class="required">*</span></label>
                    <select id="category_id" name="category_id" class="form-input" required>
                        <option value="" disabled selected>-- Chọn phân khúc xe --</option>
                ...
                <div class="form-group col-span-2">
                    ...
                    <textarea id="description" name="description" class="form-input" rows="6" placeholder="Mô tả thông số kỹ thuật, động cơ, trang bị nội ngoại thất..." required></textarea>
                </div>
            </div>
